                  ...
                  {[
                    {
                      ...
                      title: "AI Research",
                      desc: "AI searches the web and writes a structured script",
                    },
                    {
                      icon: (
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                      ...
                      title: "Screenshots",
                      desc: "AI finds and validates real screenshots for each step",
                    },
                    {
                      icon: (
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                      ...
                      title: "Video",
                      desc: "An AI voice narrates the tutorial on video",
                    },
                  ].map((s, i) => (
                    <div key={i} className="bg-white/[0.02] border border-white/5 rounded-xl p-5 text-center">
                      <div className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 mb-3">
                        {s.icon}
                      </div>
