    ...
    <div className="min-h-screen bg-slate-950 text-white overflow-x-hidden">
          ...
          <div className="mt-16 max-w-3xl mx-auto rounded-2xl overflow-hidden border border-white/10 bg-slate-900/60 backdrop-blur shadow-2xl shadow-indigo-500/5">
            <div className="flex items-center gap-2 px-4 py-3 bg-slate-900/80 border-b border-white/5">
              ...
              <div className="flex-1 mx-8">
                <div className="bg-white/5 rounded-md px-3 py-1 text-[11px] text-slate-600 text-center">app.showmeai.com/dashboard</div>
              </div>
            </div>
      ...
      <section id="gallery" className="py-24 px-6 border-t border-white/5">
        <div ref={gallery.ref} className={`max-w-6xl mx-auto transition-all duration-700 ${gallery.cls}`}>
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 mt-4">These are actual tutorials created with ShowMe AI — click to watch</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                {[
                  { icon: icons.link, title: "SEO-friendly URLs", desc: "showmeai.com/tutorial/deploy-nextjs-vercel" },
            ...
            <div className="space-y-3">
              {(tutorials.length > 0
                ...
                <div key={i} className="bg-white/[0.02] border border-white/5 rounded-xl p-4 hover:bg-white/[0.04] transition">
                  <p className="text-[11px] text-green-400/60 font-mono mb-1 truncate">showmeai.com{p.url}</p>
      ...
      <footer className="border-t border-white/5 py-10 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <span className="text-lg font-bold">ShowMe<span className="text-indigo-400">AI</span></span>
